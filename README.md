<h1><img src="https://github.com/ChenFengling/HiCpipe/blob/master/HiCpipelogo.png" alt="HiCpipe Logo" style="float:left; margin-right:20px;" width="80" height="50"/>HiCpipe – user guide</h1>
